...
Since the start of the project, an increasing number of people contributed data, hosted devices or advanced the website.
...
This website was build by Leonardo Rydin Gorjão and Galib Hassan. The lastest version is maintained by the DRACOS group at KIT, including Hallah Butt, Xinyi Wen, Ulrich Oberhofer, Sebastian Pütz and Benjamin Schäfer.

### Funding
We have received funding from numerous sources while creating, maintaining and updating this website. This includes:
- Federal Ministry of Education and Research (BMBF grants No 03SF0472 and 03EK3055)
- Helmholtz Association (via the joint initiative *Energy System 2050 - A Contribution of the Research Field Energy* and the associative *Uncertainty Quantification – From Data to Reliable Knowledge (UQ)* with grant No ZT-I-0029)
- Helmholtz Association's Initiative and Networking Fund through Helmholtz AI and grant No VH-NG-1025
- Helmholtz School for Data Science in Life, Earth and Energy (HDS-LEE)
- German Science Foundation (DFG) by a grant toward the Cluster of Excellence *Center for Advancing Electronics Dresden* (cfaed)
- Scientific Research Projects Coordination Unit of Istanbul University, Project No 32990
- European Union's Horizon 2020 research and innovation programme under the Marie Skłodowska-Curie grant agreement No 840825
- E.ON Stipendienfonds
- *STORM - Stochastics for Time-Space Risk Models* project of the Research Council of Norway (RCN) No. 274410.
